...
function AnimatedBirds() {
  const redBirdRef = useRef(null);
  const pigRef = useRef(null);
  const yellowBirdRef = useRef(null);
  const tigerRef = useRef(null);
  const torchRef = useRef(null);

  // Here we set fixed positions to push Moana and Tiger further away from the center/timer.
  // Adjust these values as needed.
  const moanaRight = '5%';  // Moana is positioned closer to the right edge
  const tigerLeft = '5%';   // Tiger is positioned closer to the left edge
